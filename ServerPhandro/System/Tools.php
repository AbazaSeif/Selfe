...
//        }
    ...
    public function Count_Hashtag($One_Word) {
        ...
        if ($GLOBALS[CLASS_DATABASE]->isExist(TABLE_HASHTAG, [FILED_HASHTAG_WORD => $One_Word])) {

            $HashWord = $GLOBALS[CLASS_DATABASE]->select(TABLE_HASHTAG, [FILED_HASHTAG_WORD => $One_Word]);
            ...
            $GLOBALS[CLASS_DATABASE]->insert(TABLE_HASHTAG, [FILED_HASHTAG_WORD => $One_Word, FILED_HASHTAG_HOW_TIME => 1]);
        }
