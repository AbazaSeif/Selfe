...
class AndroServer
{
    ...
    public function __construct()
    {
        ...
        if ($this->DebugMode) {
            echo '<b>Welcome to ' . SystemVariable(FILED_SYSTEM_APPLICATION_NAME) . ' Server</b><br>';
                ...
                if ($this->DebugMode) {
                    ...
                    <script>
                        function MovetoAdmin() {
                            ...
                            window.location.replace(dir + "/admin/login.php");
                        }
                    </script>
                    <?php

                    if (ONLINE_SERVER) {
                        echo '<b>Server ONAIR <br>Database is Online</b><br>';
                    } else {
                        echo '<b>Server OFFAIR <br>Database is Online</b><br>';
                    }
                }
            }
        }
        ...
        if ((!is_null($Key = $this->Tools->getValue(MAIN_COMMAND, $_REQUEST)))) {
            if (!is_null($Key)) {
