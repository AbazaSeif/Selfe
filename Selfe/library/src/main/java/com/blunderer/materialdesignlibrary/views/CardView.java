...
public class CardView extends android.support.v7.widget.CardView {
    ...
    public CardView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mStartPrice = a.getString(R.styleable.MDLCardView_mdl_startprice);
            mEndPrice = a.getString(R.styleable.MDLCardView_mdl_endprice);
            mCountry = a.getString(R.styleable.MDLCardView_mdl_country);
            mCity = a.getString(R.styleable.MDLCardView_mdl_city);
            mZone = a.getString(R.styleable.MDLCardView_mdl_zone);
    ...
    public void setEndPrice(String price) {
        mEndPrice = price;
        refresh();
    }
