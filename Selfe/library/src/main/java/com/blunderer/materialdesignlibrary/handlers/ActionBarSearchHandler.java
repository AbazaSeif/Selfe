...
public class ActionBarSearchHandler extends ActionBarHandler {
    ...
    private List<String> mAutoCompletionSuggestions,autoCompletionItems;
...
//    }
    ...
    public void setAutoCompletionItems(List<String> autoCompletionItems) {
        this.autoCompletionItems = autoCompletionItems;
    }
}
