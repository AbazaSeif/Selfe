 ...
 * In one case in Selfie it is more performant to work like this.
 ...
 */
public enum Theme {
    Selfie(R.color.Selfie_primary, R.color.Selfie_primary_dark,
            R.color.theme_blue_background, R.color.theme_blue_text,
            R.color.Selfie_accent, R.style.Selfie),
    blue(R.color.theme_blue_primary, R.color.theme_blue_primary_dark,
            R.color.theme_blue_background, R.color.theme_blue_text,
            R.color.theme_blue_accent, R.style.Selfie_Blue),
    green(R.color.theme_green_primary, R.color.theme_green_primary_dark,
            ...
            R.color.theme_green_accent, R.style.Selfie_Green),
    ...
    yellow(R.color.theme_yellow_primary, R.color.theme_yellow_primary_dark,
            ...
            R.color.theme_yellow_accent, R.style.Selfie_Yellow);
