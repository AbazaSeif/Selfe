...
import com.aprivate.selfie.ActivityItem.item_activity;
...
public class CategorySelectionFragment extends Fragment {
        ...
        mAdapter.setOnItemClickListener(
                new CategoryAdapter.OnItemClickListener() {
                    ...
                    public void onClick(View v, int position) {
                        ...
                        ActivityWithTransition(activity,v.findViewById(R.id.category_title),mAdapter.getItem(position));
                    }
                });
    ...
    private void ActivityWithTransition(Activity activity, View toolbar,Category category) {
        ...
        String IdThemes = category.getName();
        Toast.makeText(activity,"Name : " + IdThemes,Toast.LENGTH_SHORT).show();
        Intent StartIntent = item_activity.getStartIntent(activity, category);
