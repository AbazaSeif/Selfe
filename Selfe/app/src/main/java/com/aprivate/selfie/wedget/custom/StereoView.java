...
public class StereoView extends ViewGroup {
    ...
    private static final int standerSpeed = 1000;
    private static final int flingSpeed = 400;
    ...
    public StereoView setStartScreen(int startScreen) {
        ...
        if (startScreen < 0 || startScreen > count) {
            throw new IndexOutOfBoundsException("error startScreen");
    ...
    public StereoView setItem(int itemId) {
        ...
        if (itemId < 0 || itemId > (getChildCount() - 1)) {
            throw new IndexOutOfBoundsException("Item Not find Out of the Index");
